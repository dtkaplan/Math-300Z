...
- **Student-notes**: "Student notes" refers to a set of student-facing **Rmd** files, one for each Lesson. They are usually based on the [Learning Challenges](LC-list.html) Students are expected to work through the notes, answering the questions by completing code chunks and writing short free response answers. A good daily assignment would be complete the notes and compile them to PDF format. 
