...
#| fig-cap: "Planet Alt, that is,  $\given H_a)$ might look like this. We draw it as a cartoon planet, since any particular hypothesis is a simplified description."
#| column: margin
...
Trials %>%
  ...
  ggplot(aes(y = coefficient, x = "All")) +
