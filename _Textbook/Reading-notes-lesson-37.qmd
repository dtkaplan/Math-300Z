...
THE ROOT OF THE CALCULATION. CREATE A SIMULATION of what would happen if the null hypothesis were true. This is remarkably easy, which is why hypothesis testing is used so much.

SPACE SHUFFLE TO PLANET NULL. Calculate the likelihood of the observed result on that planet, that is, assuming that the null hypothesis is true.
