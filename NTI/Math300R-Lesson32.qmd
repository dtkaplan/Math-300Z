...
Introduce words related to "risk" and try to convert them into seeing a continuum of "risk" to "opportunity," that is, uncertain outcomes that could be positive or negative. ("Risk reduction," "volatility").
