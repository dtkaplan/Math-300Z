...
Math 300Z is the prototype for scheduled revisions to Math 300. The revisions apply only to Lessons 19 and up; the first 18 lessons will come from Math 300.

Lesson 19. Topic: Variation :: `r reading_link(19)`, Activity: [measuring by eye](Activities/)

Lesson 20: Topic: DAGs and simulation :: `r reading_link(19)`, Activity: [Smoking and birthweight](Activities/)
...
[Link to first 18 classes from January & February, 2023]{index.html#secfirst-half}
