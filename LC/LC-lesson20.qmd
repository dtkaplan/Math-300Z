...
@sec-size-of-variable describes two very closely related summary quantities used to measures of the "size" of a variable: a) the variance and b) the "standard deviation" (which is the square root of the variance).
