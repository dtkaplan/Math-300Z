...
Calculate the number of false positives and false negatives as a function of the threshold. 

Turn the results in the Training group into a sensitivity and specificity. 

---------

Explain in everyday terms why the following is true:
$p(H \given \Ptest) = 1 - p(C \given \Ptest)$
