...
\underbrace{e^{-6.5}}_\text{baseline} \times \underbrace{e^{0.35}}_\text{odds ratio} \times \underbrace{e^{5}}_\text{odds ratio}$$
$$ odds = \underbrace{0.0015}_\text{baseline} \times \underbrace{1.42}_\text{odds ratio for smoking} \times \underbrace{148.4}_\text{odds ratio for age 50}$$
