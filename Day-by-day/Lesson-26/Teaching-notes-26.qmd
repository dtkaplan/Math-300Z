...
We're going to be talking about probability today.

- There are just a few skills/concepts that have exam potential.
- Much of the class will be about concepts that educated people should know about but about which technical skills for calculations can be left to specialists.
    * What can't be left to specialists: **knowing what questions to ask.**
    
Basketball feat, solar system trajectories, terminal guidance


[Drone video](https://www.youtube.com/watch?v=DOWDNBu9DkU)

360 hospitals, each with a 1% chance of needing a medicine/blood/etc in the interval before it expires.

- How many units should they keep on hand?

```{r}
plot(table(rbinom(20000, 360, p=0.01)), ylab="Relative probability",
     xlab="Number of units needed.")
```
...
[Federal reserve forecasts](https://www.nytimes.com/live/2023/03/22/business/fed-interest-rates#:~:text=In%20its%20latest%20economic%20projections,by%20the%20end%20of%202024.)
