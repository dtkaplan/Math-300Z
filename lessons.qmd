...
lesson_links <- function(n) {
  str <- "[NTI](NTI/NTI-Lesson{n}.html) : [Objectives](Objectives/Obj-lesson-{n}.html) : [LC](LC-lesson{n}.html) : [Reading](Reading-notes/Reading-notes-lesson-{n}.html) : [Student notes](Student-notes-lesson-{n}.Rmd)"
