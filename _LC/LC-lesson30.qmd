...
As we will see in Lesson 28, to reveal the direct causal link between engine power and fuel economy requires different choices for the model specification depending on which DAG you think might be relevant.
:::
